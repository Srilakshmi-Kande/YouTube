    ...
    <header className='flex items-center justify-between px-4 py-2 bg-white border-b'>
        ...
        <form onSubmit={handleSearch} className='flex items-center gap-2 flex-1 max-w-xl mx-4'>
            <div className='flex flex-1'>
                <Input type='search' placeholder='Search' value={searchQuery} onKeyPress={handleKeyPress} onChange={(e)=>setSearchQuery(e.target.value)} className='rounded-l-full border-r-0 focus-visible:ring-0' />
            ...
            {user? <>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-56" align='end' forceMount>
                        {user?.channelname ? (<DropdownMenuItem asChild>
